...
- (void)setupParamData {
    ...
    _dataArray = @[cellModel1,cellModel2,cellModel3,cellModel4,cellModel5,cellModel6,cellModel7,cellModel8,cellModel8_1,cellModel8_2,cellModel8_3,cellModel8_4,cellModel9_1,cellModel9,cellModel10];
#else
    [[NSUserDefaults standardUserDefaults] setObject:@"FaceUnity" forKey:@"AlivcBeautyType_cell"];
